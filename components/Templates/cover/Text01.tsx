...
export function Text01({ values }: Props) {
  const text = values.announcement || '2026 Meta hire to fire: All areas have minimum 10% cuts at Meta'

  return (
    <div className="relative" style={{ width: 1080, height: 1350, background: '#111' }}>
      {/* 고정: Blind 로고 좌상단 */}
      <div className="absolute" style={{ left: 64, top: 64 }}>
        <img src="/assets/text01_logo.png" alt="blind" style={{ height: 64, width: 'auto', objectFit: 'contain' }} />
      </div>
